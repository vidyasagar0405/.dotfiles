...
static const char *fonts[]          = {"JetBrainsMono Nerd Font:style:medium:size=10" ,"Iosevka:style:medium:size=10",
...
static const char *colors[][3]      = {
    ...
    [SchemeColorBT]    = { orange,   black,  black }, // color btop launcher icon
    [SchemeColorPM]    = { pink,   black,  black }, // color powermenu launcher icon
};
...
static Key keys[] = {
    ...
    // kill dwm
    { MODKEY|ShiftMask,                 XK_q,       spawn,        SHCMD(". /home/vs/.config/powermenu/powermenu.sh") },
